...
-   __PSBBN DP__![sascompat][sas-compat]{ width="60" }![nonsas-ext_pic][non-sas-ext]{ width="75" }
    ...
    [:material-cloud-download: PSBBN Forwarder](https://downloads.ps2homebrewstore.com/SAS/APP_PSBBN-FORWARDER.psu) Using `OSDMenu Launcher` with quickboot handler as a forwarder, this allows one to launch PSBBN from just about any application regardless of drivers installed or not.  
    PSU Paste to root of Memory Card
